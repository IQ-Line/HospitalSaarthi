...
import { fetchOpdPatientsList } from '../../../../../src/features/opd-patients/api/opd-patients';
...
vi.mock('../../../../../src/features/opd-patients/api/empi-patients', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../../../../../src/features/opd-patients/api/empi-patients')>();
  return {
    ...actual,
...
vi.mock('../../../../../src/features/opd-patients/api/opd-encounter-overlay', async (importOriginal) => {
  const actual = await importOriginal<typeof import('../../../../../src/features/opd-patients/api/opd-encounter-overlay')>();
  return {
    ...actual,
...
import { fetchOpdEncounterOverlaysByVisitIds } from '../../../../../src/features/opd-patients/api/opd-encounter-overlay';
import { fetchEmpiPatientLookupMap } from '../../../../../src/features/opd-patients/api/empi-patients';
