...
export const inventoryQueryKeys = {
  ...
  dashboardLowStock: (storeId?: string) =>
    [...inventoryQueryKeys.all, 'dashboard', 'low-stock', storeId] as const,
  expiringLots: (storeId?: string, withinDays?: number) =>
    [...inventoryQueryKeys.all, 'expiring-lots', storeId, withinDays] as const,
