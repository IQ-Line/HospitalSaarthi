...
function LoginPage() {
  ...
  async function completeSignIn(sessionToken: string, user: { id: string; name: string; iq_tenant_id?: string }) {
          ...
          {showDevShortcuts ? (
            ...
            <div className="mt-6 space-y-2 border-t pt-4">
              ...
              <p className="pt-1 text-xs text-muted-foreground">
                ...
                Capabilities load from <code className="text-[0.7rem]">GET /auth/principal</code> after

                sign-in. Cerbos PDP remains authoritative on APIs.
