...
export const DEV_CATALOG_L1_FIXTURE: ModuleCatalogIndex = (() => {
  ...
  const byId = new Map<string, ModuleCatalogIndex['bySlug'] extends Map<string, infer E> ? E : never>();
  const bySlug = new Map<string, ModuleCatalogIndex['bySlug'] extends Map<string, infer E> ? E : never>();
