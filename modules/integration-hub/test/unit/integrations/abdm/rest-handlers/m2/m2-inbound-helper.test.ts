...
import { EmpiClientError } from "../../../../../../src/integrations/abdm/lib/empi-client-error.js";
import { runInboundCallback } from "../../../../../../src/integrations/abdm/rest-handlers/m2/m2-inbound-helper.js";

vi.mock("../../../../../../src/lib/build-abdm-deps.js", () => ({
...
describe("runInboundCallback", () => {
  ...
  it("releases idempotency row when handler fails so gateway can retry", async () => {
    ...
    const { buildAbdmDepsForTenant } = await import("../../../../../../src/lib/build-abdm-deps.js");
