...
CREATE TABLE IF NOT EXISTS integration_hub.abdm_sessions (
...
CREATE INDEX IF NOT EXISTS idx_abdm_sessions_txn
  ON integration_hub.abdm_sessions (iq_tenant_id, txn_id);

CREATE INDEX IF NOT EXISTS idx_abdm_sessions_flow_state
  ON integration_hub.abdm_sessions (iq_tenant_id, flow_kind, state);
