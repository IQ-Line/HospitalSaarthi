...
import { registerInternalTenantEntitlementHandler } from "../../../src/rest-handlers/internal-tenant-entitlement.handler.js";
import {
  CONFIGURATOR_IDENTITY_SKIP_PATH_PREFIXES,
  CONFIGURATOR_INTERNAL_INTEGRATION_PROFILE_PATHS,
} from "../../../src/http/configurator-identity-skip-paths.js";
...
vi.mock("../../../src/use-cases/list-entitlement-enabled-module-ids.js", () => ({
