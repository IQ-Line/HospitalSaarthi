...
CREATE TABLE IF NOT EXISTS abdm_adapter.abdm_m3_consent_requests (
...
CREATE INDEX IF NOT EXISTS ix_m3_consent_requests_session
  ON abdm_adapter.abdm_m3_consent_requests (iq_tenant_id, session_id);
CREATE INDEX IF NOT EXISTS ix_m3_consent_requests_state
  ON abdm_adapter.abdm_m3_consent_requests (iq_tenant_id, state);

CREATE TABLE IF NOT EXISTS abdm_adapter.abdm_m3_consent_artefacts_hiu (
  iq_tenant_id           uuid NOT NULL,
...
CREATE INDEX IF NOT EXISTS ix_m3_artefacts_hiu_patient
  ON abdm_adapter.abdm_m3_consent_artefacts_hiu (iq_tenant_id, patient_abha_address);
CREATE INDEX IF NOT EXISTS ix_m3_artefacts_hiu_request
  ON abdm_adapter.abdm_m3_consent_artefacts_hiu (iq_tenant_id, consent_request_id);

CREATE TABLE IF NOT EXISTS abdm_adapter.abdm_m3_data_transfers (
  iq_tenant_id            uuid NOT NULL,
...
CREATE INDEX IF NOT EXISTS ix_m3_transfers_consent
  ON abdm_adapter.abdm_m3_data_transfers (iq_tenant_id, consent_id);
CREATE INDEX IF NOT EXISTS ix_m3_transfers_txn
  ON abdm_adapter.abdm_m3_data_transfers (iq_tenant_id, cm_transaction_id);
CREATE INDEX IF NOT EXISTS ix_m3_transfers_awaiting
  ON abdm_adapter.abdm_m3_data_transfers (awaiting_push_until)
