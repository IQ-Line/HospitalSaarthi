...
-- Apply after 0000_abdm_adapter_schema.sql

CREATE TABLE IF NOT EXISTS abdm_adapter.abdm_inbound_messages (
...
CREATE TABLE IF NOT EXISTS abdm_adapter.abdm_link_tokens (
  iq_tenant_id        uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS abdm_adapter.abdm_consent_artefacts (
  iq_tenant_id      uuid NOT NULL,
...
CREATE INDEX IF NOT EXISTS ix_abdm_consent_patient
  ON abdm_adapter.abdm_consent_artefacts (iq_tenant_id, patient_id);

CREATE INDEX IF NOT EXISTS ix_abdm_consent_data_erase
  ON abdm_adapter.abdm_consent_artefacts (data_erase_at)
