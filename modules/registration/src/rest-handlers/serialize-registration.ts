...
/** Desk workflow response — merges registration snapshot with visit encounter fields. */
...
export function serializeRegistrationWithVisitFromParts(
  registration: RegistrationRecord | null | undefined,
  visit: VisitRecord,
): RegistrationResponse {
  return serializeRegistrationWithVisit({
