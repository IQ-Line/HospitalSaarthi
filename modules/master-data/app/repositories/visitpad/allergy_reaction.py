"""Database access for the Visitpad ``allergy_reactions`` catalog (``master_global`` vs ``master_tenant``)."""
...
from app.catalog.visitpad.table_models import visitpad_allergy_reaction_model
