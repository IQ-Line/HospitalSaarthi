"""SQLAlchemy models for Visitpad ``manufacturers`` — global_master vs ``tenant_master``."""
...
class VisitpadManufacturerPublicModel(TimestampMixin, AuditActorMixin, Base):
...
class VisitpadManufacturerTenantModel(TimestampMixin, AuditActorMixin, Base):
    __tablename__ = "manufacturers"
    __table_args__ = (
        Index(
...
VisitpadManufacturerModel = VisitpadManufacturerPublicModel
