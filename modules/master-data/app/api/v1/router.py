...
from app.api.v1.picklists import router as picklists_router
from app.api.v1.system_role_permissions import router as system_role_permissions_router
...
api_router.include_router(picklists_router)
api_router.include_router(system_roles_router)
api_router.include_router(module_permissions_router)
api_router.include_router(system_role_permissions_router)
