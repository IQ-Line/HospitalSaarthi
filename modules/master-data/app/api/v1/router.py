...
from app.api.v1.visitpad_allergies import allergens_router, reactions_router
from app.api.v1.visitpad_chief_complaints import router as visitpad_chief_complaints_router
from app.api.v1.visitpad_chronic_illnesses import router as visitpad_chronic_illnesses_router
from app.api.v1.visitpad_diagnoses import router as visitpad_diagnoses_router
from app.api.v1.visitpad_medicines import router as visitpad_medicines_router
from app.api.v1.visitpad_procedures import router as visitpad_procedures_router
from app.api.v1.visitpad_rx_columns import router as visitpad_rx_columns_router
from app.api.v1.visitpad_units import conversions_router, units_router
from app.api.v1.visitpad_vitals import router as visitpad_vitals_router
