...
export async function getStockTransfer(
  ...
  return {
    ...
    lines: lines.map((line) => ({
      ...
      received_qty: line.received_qty != null ? Number(line.received_qty) : null,
      accepted_qty: line.accepted_qty != null ? Number(line.accepted_qty) : null,
      rejected_qty: line.rejected_qty != null ? Number(line.rejected_qty) : null,
