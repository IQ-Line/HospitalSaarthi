...
- [Master Data — Schema Design](lld/master-data/01-schema-design.md) — MVP platform catalog (module tree, permissions, role templates, picklists), Configurator-facing registry (config schemas, feature flags), audit trail; Post-launch healthcare reference sketch. Includes [ERD](lld/master-data/master-data.erd.json).
