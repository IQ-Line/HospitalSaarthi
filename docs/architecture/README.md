...
- [Master Data — Schema Design](lld/master-data/01-schema-design.md) — module/feature registry (MVP), healthcare reference data backbone (Post-launch sketch). Module registration lifecycle, config schema declarations, feature flag definitions. Includes [ERD](lld/master-data/master-data.erd.json).
