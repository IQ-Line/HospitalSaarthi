 ...
 */
import type { Composition, CompositionAttester, CompositionSection, FhirCodeableConcept, FhirDateTime, FhirReference, FhirIdentifier } from '../types/index.js';
 ...
 * @see docs/architecture/adr/0023-distributed-fhir-assembly.md
 */
export declare function buildComposition(_input: BuildCompositionInput): Composition;
