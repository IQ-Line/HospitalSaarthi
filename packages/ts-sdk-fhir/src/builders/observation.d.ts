 ...
 */
import type { Observation, FhirCodeableConcept, FhirDateTime, FhirIdentifier, FhirReference } from '../types/index.js';
 ...
 * @see docs/architecture/adr/0023-distributed-fhir-assembly.md
 */
export declare function buildObservation(_input: BuildObservationInput): Observation;
