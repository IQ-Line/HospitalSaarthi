 ...
 */
import type { DiagnosticReport, FhirCodeableConcept, FhirDateTime, FhirIdentifier, FhirInstant, FhirReference } from '../types/index.js';
 ...
 * @see docs/architecture/adr/0023-distributed-fhir-assembly.md
 */
export declare function buildDiagnosticReport(_input: BuildDiagnosticReportInput): DiagnosticReport;
//# sourceMappingURL=diagnostic-report.d.ts.map