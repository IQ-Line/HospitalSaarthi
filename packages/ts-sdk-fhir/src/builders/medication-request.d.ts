 ...
 */
import type { MedicationRequest, FhirCodeableConcept, FhirDateTime, FhirIdentifier, FhirReference } from '../types/index.js';
 ...
 * @see docs/architecture/adr/0023-distributed-fhir-assembly.md
 */
export declare function buildMedicationRequest(_input: BuildMedicationRequestInput): MedicationRequest;
//# sourceMappingURL=medication-request.d.ts.map