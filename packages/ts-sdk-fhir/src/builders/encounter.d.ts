 ...
 */
import type { Encounter, FhirCodeableConcept, FhirCoding, FhirIdentifier, FhirPeriod, FhirReference } from '../types/index.js';
 ...
 * @see docs/architecture/adr/0023-distributed-fhir-assembly.md
 */
export declare function buildEncounter(_input: BuildEncounterInput): Encounter;
