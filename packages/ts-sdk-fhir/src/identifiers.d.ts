...
export declare const ABHA_NUMBER_SYSTEM_URI = "https://healthid.ndhm.gov.in";
/** ABHA Address (alias@suffix, e.g. `ramesh@sbx`). */
export declare const ABHA_ADDRESS_SYSTEM_URI = "https://abdm.gov.in/identifier/abha-address";
...
export declare const MRN_SYSTEM_URI = "https://hims.local/identifier/mrn";
